...
| 项目名称 | 核心功能 | 开发语言 | 项目地址 |
| --- | --- | --- | --- |
| cockroach | 分布式SQL数据库，高可用性,扩展 | Go | [https://github.com/cockroachdb/cockroach](https://github.com/cockroachdb/cockroach) |
| dgraph | 分布式图数据库，支持高性能查询 | Go | [https://github.com/hypermodeinc/dgraph](https://github.com/hypermodeinc/dgraph) |
| dynamo | 数据中心规模分布式推理服务框架 | Rust | [dynamo](https://github.com/ai-dynamo/dynamo) |
| surrealdb | 实时 Web 的可扩展、分布式、协作式文档图数据库 | Rust | [https://github.com/surrealdb/surrealdb](https://github.com/surrealdb/surrealdb) |
| influxdb | 时序数据库，处理大规模时间序列数据 | Rust | [https://github.com/influxdata/influxdb](https://github.com/influxdata/influxdb) |
| crate | 分布式SQL数据库，面向时间序列和物联网 | Java | [https://github.com/crate/crate](https://github.com/crate/crate) |
| lakeFS | 开源数据湖版本控制系统 | Go | [https://github.com/treeverse/lakeFS](https://github.com/treeverse/lakeFS) |
| lance | 用于 ML 的现代列式数据格式 | Rust | [https://github.com/lancedb/lance](https://github.com/lancedb/lance) |
|X databend | AI云原生数据仓库,结构化、半结构化和非结构化,下一代云 [数据+AI] 分析 | Rust | [https://github.com/databendlabs/databend](https://github.com/databendlabs/databend) |
| oceanbase | 分布式关系数据库 | C++ | [https://github.com/oceanbase/oceanbase](https://github.com/oceanbase/oceanbase) |
| materialize | SQL实时数据集成平台 | Rust | [https://github.com/MaterializeInc/materialize](https://github.com/MaterializeInc/materialize) |
| doris | 易用、高性能、实时的分析数据库 | Groovy | [https://github.com/apache/doris](https://github.com/apache/doris) |
|X ClickHouse | 列式数据库，支持高性能分析 | C++ | [https://github.com/ClickHouse/ClickHouse](https://github.com/ClickHouse/ClickHouse) |
| incubator-hugegraph | 图数据库 | Java | [https://github.com/apache/incubator-hugegraph](https://github.com/apache/incubator-hugegraph) |
| horaedb | 时序数据库 | Rust | [https://github.com/apache/horaedb](https://github.com/apache/horaedb) |
| LakeSoul | 云原生湖仓一体框架 | Java/Scala | [https://github.com/lakesoul-io/LakeSoul](https://github.com/lakesoul-io/LakeSoul) |
| qdrant | 向量搜索引擎和向量数据库 | Rust | [https://github.com/qdrant/qdrant](https://github.com/qdrant/qdrant) |
| meilisearch | 搜索引擎 API | Rust | [https://github.com/meilisearch/meilisearch](https://github.com/meilisearch/meilisearch) |
| dragonfly | 新一代内存数据存储 | C++ | [https://github.com/dragonflydb/dragonfly](https://github.com/dragonflydb/dragonfly) |
| minio | 分布式对象存储服务器 | Go | [https://github.com/minio/minio](https://github.com/minio/minio) |
| seafile | 企业文件同步与共享 | C | [https://github.com/haiwen/seafile](https://github.com/haiwen/seafile) |
| rustfs | Rust实现的分布式对象存储软件,Minio竞品 | Rust | [https://github.com/rustfs/rustfs](https://github.com/rustfs/rustfs) |
| pocketbase | 嵌入式数据库和后端 | Go | [https://github.com/pocketbase/pocketbase](https://github.com/pocketbase/pocketbase) |
| supabase | 开源后端即服务，Postgres 开发平台 | TypeScript | [https://github.com/supabase/supabase](https://github.com/supabase/supabase) |

### 流处理与消息队列

| 项目名称 | 核心功能 | 开发语言 | 项目地址 |
| --- | --- | --- | --- |
|X arroyo | 分布式流处理引擎 | Rust | [https://github.com/ArroyoSystems/arroyo](https://github.com/ArroyoSystems/arroyo) |
| storm | 分布式实时计算系统 | Java | [https://github.com/apache/storm](https://github.com/apache/storm) |
|X redpanda | 高性能Kafka兼容流平台,更轻、更快流数据平台 | C++ | [https://github.com/redpanda-data/redpanda](https://github.com/redpanda-data/redpanda) |
| nsq | 实时分布式消息传递平台 | Go | [https://github.com/nsqio/nsq](https://github.com/nsqio/nsq) |
| centrifugal | 语言无关,实时消息服务器 | Go | [https://github.com/centrifugal/centrifugo](https://github.com/centrifugal/centrifugo) |
| libzmq | ZeroMQ消息库 | C++ | [https://github.com/zeromq/libzmq](https://github.com/zeromq/libzmq) |

### 观测、监控与日志追踪

| 项目名称 | 核心功能 | 开发语言 | 项目地址 |
| --- | --- | --- | --- |
| jaeger | 分布式追踪系统，监控微服务调用链 | Go | [https://github.com/jaegertracing/jaeger](https://github.com/jaegertracing/jaeger) |
| openobserve | 开源观察数据平台，实时分析 | Rust | [https://github.com/openobserve/openobserve](https://github.com/openobserve/openobserve) |
| VictoriaMetrics | 快速、低成本，监控和管理时间序列数据 | Go | [https://github.com/VictoriaMetrics/VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) |
| helicone | AI API监控平台 | TypeScript | [https://github.com/Helicone/helicone](https://github.com/Helicone/helicone) |
| onlook | 可视化监控平台 | TypeScript | [https://github.com/onlook-dev/onlook](https://github.com/onlook-dev/onlook) |

### 后端与微服务框架

| 项目名称 | 核心功能 | 开发语言 | 项目地址 |
| --- | --- | --- | --- |
| gofr | Go语言微服务框架，简化微服务开发 | Go | [https://github.com/gofr-dev/gofr](https://github.com/gofr-dev/gofr) |
| dapr | 构建安全可靠的微服务的 API | Go | [https://github.com/dapr/dapr](https://github.com/dapr/dapr) |
| kitex | 高性能Go RPC框架 | Go | [https://github.com/cloudwego/kitex](https://github.com/cloudwego/kitex) |
| Tars | 微服务框架,实现托管服务 | C++ | [https://github.com/TarsCloud/Tars](https://github.com/TarsCloud/Tars) |
| kratos | Go微服务治理框架 | Go | [https://github.com/go-kratos/kratos](https://github.com/go-kratos/kratos) |
| actix | Rust 的 Actor 框架 | Rust | [https://github.com/actix/actix](https://github.com/actix/actix) |
| graphiti | 用于构建和查询时间感知知识图谱的框架 | Python | [https://github.com/getzep/graphiti](https://github.com/getzep/graphiti) |
| consul | 用于跨动态分布式基础设施连接和配置应用程序 | Go | [https://github.com/hashicorp/consul](https://github.com/hashicorp/consul) |

### 无服务器与函数计算

| 项目名称 | 核心功能 | 开发语言 | 项目地址 |
| --- | --- | --- | --- |
|X nuclio | 高性能无服务器计算平台 | Go | [https://github.com/nuclio/nuclio](https://github.com/nuclio/nuclio) |
| shuttle | 构建和交付后端，无需编写任何基础设施文件 | Rust | [https://github.com/shuttle-hq/shuttle](https://github.com/shuttle-hq/shuttle) |
| serverless | 无服务器框架 | JavaScript | [https://github.com/serverless/serverless](https://github.com/serverless/serverless) |
| convex-backend | 反应式数据库 | Rust | [https://github.com/get-convex/convex-backend](https://github.com/get-convex/convex-backend) |

### AI/ML/LLM 与 MLOps

| 项目名称 | 核心功能 | 开发语言 | 项目地址 |
| --- | --- | --- | --- |
| burn | 下一代深度学习框架，在灵活性、效率和可移植性方面毫不妥协 | Rust | [https://github.com/tracel-ai/burn](https://github.com/tracel-ai/burn) |
| h2o-3 | 开源机器学习和自动化平台 | Jupyter | [https://github.com/h2oai/h2o-3](https://github.com/h2oai/h2o-3) |
| BentoML | 构建AI应用程序和模型推理优化的在线服务系统 | Python | [https://github.com/bentoml/BentoML](https://github.com/bentoml/BentoML) |
| flair | 简单的最先进 NLP 框架 | Python | [https://github.com/flairNLP/flair](https://github.com/flairNLP/flair) |
| transformers | 用于推理和训练 | Python | [https://github.com/huggingface/transformers](https://github.com/huggingface/transformers) |
| pycaret | 低代码机器学习库 | Jupyter | [https://github.com/pycaret/pycaret](https://github.com/pycaret/pycaret) |
| StableLM | 开源语言模型 | Jupyter | [https://github.com/Stability-AI/StableLM](https://github.com/Stability-AI/StableLM) |
| llama | Meta开源语言模型 | Python | [https://github.com/meta-llama/llama](https://github.com/meta-llama/llama) |
| gpt4all | 任何设备上运行本地 LLM | C++ | [https://github.com/nomic-ai/gpt4all](https://github.com/nomic-ai/gpt4all) |
| ollama | 本地化LLM模型管理 | Go | [https://github.com/ollama/ollama](https://github.com/ollama/ollama) |
...
|X kedro | 生产就绪数据科学的工具箱 | Python | [https://github.com/kedro-org/kedro](https://github.com/kedro-org/kedro) |
...
| dbt | 数据分析师和工程师能够使用与软件工程师用于构建应用程序相同的做法来转换他们的数据 | Python | [dbt](https://github.com/dbt-labs/dbt-core) |
...
|X nautilus_trader | 生产级算法交易平台 回测 | Rust/Python | [https://github.com/nautechsystems/nautilus_trader](https://github.com/nautechsystems/nautilus_trader) |
